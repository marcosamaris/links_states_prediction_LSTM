...
for line in selected_line:  
    ...
    encoder.summary()
    plot_model(encoder, to_file='minmax_updown_vae_encoder.png', show_shapes=True)
    ...
    decoder.summary()
    plot_model(encoder, to_file='minmax_updown_vae_decoder.png', show_shapes=True)
    ...
    vae.summary()   
    plot_model(encoder, to_file='minmax_updown_vae.png', show_shapes=True)
    ...
    plt.xticks(x, (ML_alg))
    plt.savefig('MAE_encode_minmax_updown_' + line + '.png')
    ...
    plt.xticks(x, (ML_alg))
    plt.savefig('MAE_decode_minmax_updown_' + line + '.png')
